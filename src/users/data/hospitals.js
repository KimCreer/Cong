...
const COMMON_REQUIREMENTS = {
  LOCAL_HOSPITAL: [
    "Medical Certificate / Clinical Abstract (Para sa mga In-Patient) / Medical Certificate (Para sa mga Outpatient)",
...
export const HOSPITALS = [
  // ==================== 🟢 MGA HOSPITAL NA MAY GUARANTEE LETTER ====================
  {
    ...
    color: "#4CAF50",
    requirements: COMMON_REQUIREMENTS.LOCAL_HOSPITAL
  },
  {
    id: 4,
  ...
  // ==================== 🔵 MEDICAL FINANCIAL (MGA DOH HOSPITAL) ====================
  {
    id: 2,
    ...
    color: "#2196F3",
    requirements: COMMON_REQUIREMENTS.DOH_WITH_SOCIAL_CASE
  },
  {
    id: 3,
    ...
    color: "#2196F3",
    requirements: COMMON_REQUIREMENTS.NKTI
  },
  {
    id: 7,
    ...
    color: "#2196F3",
    requirements: COMMON_REQUIREMENTS.DOH_BASIC
  },
  {
    id: 8,
  ...
  },
  {
    ...
    color: "#2196F3",
    requirements: COMMON_REQUIREMENTS.PEDIATRIC
  },
  {
    id: 12,

...
// Concise and complementary language translations
const translations = {
  en: {
    welcome: "Welcome Back!",
    noAppointments: "No schedules yet",
    scheduleNow: "Book Now",
    latestPosts: "Latest News",
    noPosts: "No news yet",
    viewAllPosts: "See All",
    upcomingAppointments: "Upcoming",
    viewAll: "See All",
    districtOffice: "Office Location",
    help: "Help",
  ...
  tl: {
    welcome: "Maligayang Balik!",
    noAppointments: "Walang iskedyul",
    scheduleNow: "Mag-book",
    latestPosts: "Bagong Balita",
    noPosts: "Walang balita",
    viewAllPosts: "Tingnan Lahat",
    upcomingAppointments: "Paparating",
    viewAll: "Tingnan Lahat",
    districtOffice: "Lokasyon",
    help: "Tulong",
    selectLanguage: "Wika",
    close: "Isara",
    services: {
